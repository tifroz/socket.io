...
Client.prototype._onConnect = function(req, res){
  ...
  if (attachConnection){
    function destroyConnection(){
      //Hugo: removing this line because it causes a rest of all the connections with xhr-polling
			//Careful!! It is possible that this change would impact nagatively other transports
			//(was only tested with xhr-polling)
			//self._onClose();
